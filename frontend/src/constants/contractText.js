  ...
  <Card>
    <Card.Body>
      ...
      <Card.Text>
        <ol>
          <li>
            Dealer and Operator expressly agree that for the term of this agreement Operator is not and does not become an agent, servant, or employee of Dealer in any manner whatsoever.
          </li>
          <li>
          ...
          <li>
            Operator agrees that the vehicle will not be operated in violation of any law governing the use or return thereof, or in violation of any of the other terms and conditions set forth above.
          </li>
          <li>
            Operator agrees that he will not operate the vehicle outside the state of Washington.
          </li>
          <li>
            Operator expressly agrees that the motor vehicle given to him shall not be operated:
            <ol type='a'>
              <li>
                To carry passengers for a consideration, express or implied, or in connection with the Operator’s employment;
              </li>
              <li>
              ...
              <li>
                By any person with a suspended or revoked or invalid driver’s license;
              </li>
              <li>
          ...
          <li>
            The Dealer is not providing insurance of any nature or kind including but not limited to collision or public liability insurance. Operator must have his own insurance in order to be protected.
          </li>
          <li>Operator agrees to replace gasoline used if the vehicle is driven over 50 miles.
          </li>
        </ol>
      </Card.Text>
    </Card.Body>
